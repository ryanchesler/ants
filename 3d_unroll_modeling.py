...
class CFG:
    ...
    # starting_checkpoint = f"/home/ryanc/kaggle/working/outputs/vesuvius_unroll_3d/{exp_name}/vesuvius_unroll_3d-models/{exp_name}_3d_unet_best.pth"
    # ============== pred target =============
    target_size = 1
    # ============== model cfg =============
    model_name = '3d_unet'
